...
int flight(int num_model)
{
    ...
    double inclination_c=0, declination_c=11;
    switch (num_model)
    {
    case 1:
        ...
        for(int i=0;i<Time_work;i++)
        {
            ...
            char sql[256];
            snprintf(sql, sizeof(sql), "INSERT INTO model_flight VALUES (%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f)",i,X,Y,h_m,ox_c,oy_c,oz_c,vx_msec,vy_msek,vz_msek,vox_csec,voy_csec,voz_csec,ax_m2sec,ay_m2sec,az_m2sec,inclination_c,declination_c);
